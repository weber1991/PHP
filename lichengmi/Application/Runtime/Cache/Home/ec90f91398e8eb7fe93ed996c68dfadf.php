...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
        <div class="col-lg-12">
                        <link rel="stylesheet" type="text/css" href="/lichengmi/Public/Default/doudong/css/type2.css" />
                    <div class = "row">
    ...
    <script src="/lichengmi/Public/Default/js/jquery-ui-1.10.4.min.js"></script>
